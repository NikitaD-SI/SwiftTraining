...
class ViewController: UIViewController {
    ...
    {
        let newSurvey : SurveyModel = SurveyModel(name: personalInfo[0].text!,
                                                  dateOfBirth: agePicker.date,
                                                  email: personalInfo[2].text!,
                                                  phone: personalInfo[1].text!,
                                                  comfortRating: Rating.generate(withNumber: Int16(ratingControl[0].selectedSegmentIndex)) ,
                                                  safetyRating: Rating.generate(withNumber: Int16(ratingControl[1].selectedSegmentIndex)),
                                                  securityRating: Rating.generate(withNumber: Int16(ratingControl[2].selectedSegmentIndex)),
